...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  A2uiPage: 'A2UI page contract is owned by packages/web/tool-a2ui-surface/src/types.ts',
  A2uiRunFieldValues: 'A2UI run payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiRunHandle: 'A2UI run handle is owned by packages/web/tool-a2ui-store/src/run.ts',
  A2uiRunStart: 'A2UI run start request is owned by packages/web/tool-a2ui-store/src/run.ts',
  A2uiRunReadRequest: 'A2UI run payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiRunReadValue: 'A2UI run payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiRunScriptRequest: 'A2UI run payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiRunScriptValue: 'A2UI run payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiLiveReadRequest: 'A2UI live payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiLiveReadValue: 'A2UI live payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiLiveRead: 'A2UI live read is owned by packages/web/tool-a2ui-store/src/live.ts',
  A2uiRunStartRequest: 'A2UI run payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiRunStartValue: 'A2UI run payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiRunStopRequest: 'A2UI run payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiRunStopValue: 'A2UI run payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiStoreDeleteRequest: 'A2UI store payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiStoreImportRequest: 'A2UI store payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiStoreImportValue: 'A2UI store payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiStoreShareRequest: 'A2UI store payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiStoreShareValue: 'A2UI store payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiStoreDeleteValue: 'A2UI store payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  A2uiStoreListValue: 'A2UI store payload contract is owned by packages/web/tool-a2ui-store/src/types.ts',
  ...
  JobOutputReader: 'Job output reader contract is owned by packages/jobs/jobs/src/types.ts',
}
