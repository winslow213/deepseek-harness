...
import pluginInstallRemote from '@deepseek-ai/dsh-host-plugin-install/remote'
...
export type {} from '@deepseek-ai/dsh-host-plugin-install/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, pluginInstallRemote, messageFeedbackRemote, sessionFeedbackRemote, fileUploadsRemote,
      sessionReferencesRemote, subagentsRemote, sessionRemote, workspaceRemote, a2uiStoreRemote, a2uiDataRemote,
