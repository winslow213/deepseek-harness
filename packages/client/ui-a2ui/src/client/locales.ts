...
export const zh = {
  ...
  'launcher.popupBlocked': '弹窗被浏览器拦截，请允许本站弹窗，或',
  'launcher.openDirectly': '直接打开',
...
export const en: Record<A2uiKey, string> = {
  ...
  'launcher.popupBlocked': 'The popup was blocked by the browser; allow popups for this site, or',
  'launcher.openDirectly': 'open it directly',
