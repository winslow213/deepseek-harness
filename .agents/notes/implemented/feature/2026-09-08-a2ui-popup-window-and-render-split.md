...
- **Auto-open.** The launcher opens the newest mounted surface once after a short deferral (`lastAutoOpenKey` dedupes, so replaying a transcript with many historical launchers opens at most one window).
