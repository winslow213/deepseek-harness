...
来源：[`packages/host/plugin-install/src/types.ts`](../packages/host/plugin-install/src/types.ts)
...
来源：[`packages/web/tool-a2ui-surface/src/index.ts:38`](../packages/web/tool-a2ui-surface/src/index.ts)
