...
| `ctx.a2uiStore` | `core` | [`tool-a2ui-store`](../packages/web/tool-a2ui-store) | - | - | - | Local persistence for saved A2UI pages: name-sorted listing, canonical save, and removal under the harness A2UI tools directory. |
